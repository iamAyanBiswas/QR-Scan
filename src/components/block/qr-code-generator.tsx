...
// import { DEFAULT_BUSINESS_CARD, DEFAULT_COUPON, DEFAULT_MENU, DEFAULT_EVENT_PAGE, DEFAULT_TEXT_PAGE } from "@/config/qr-page-builder";
...
//         else if (t === "payment") setData({ gateway: "paypal", config: { recipientName: "", amount: "", currency: "USD", paypalHandle: "" } } as PaymentData);
//         else setData({});
...
//     // Helper to switch gateway and reset config to correct shape
//     const handleGatewayChange = (gw: PaymentGateway) => {
//         const base = { recipientName: data.config?.recipientName || "", amount: data.config?.amount || "", currency: data.config?.currency || "USD" };
//         switch (gw) {
...
//                                                             {/* Common fields (hidden for custom — custom only needs a URL) */}
//                                                             {data.gateway !== "custom" && (
//                                                                 <>
//                                                                     {/* Recipient Name */}
//                                                                     <InputField
...
//                                                                     value={data.config?.paypalHandle || ""}
...
//                                                                         value={data.config?.walletAddress || ""}
